...
public enum CustomItemList implements IItemContainer
{
	...
	CircuitAssemblerUHV,CircuitAssemblerUEV,CircuitAssemblerUIV,CircuitAssemblerUMV,CircuitAssemblerUXV,CircuitAssemblerOpV,CircuitAssemblerMAX,
	...
	IchoriumCap, CoinTechnician,  CoinTechnicianI,  CoinTechnicianII,  CoinTechnicianIII, CoinTechnicianIV, CoinDarkWizard, CoinDarkWizardI, CoinDarkWizardII, CoinDarkWizardIII, CoinDarkWizardIV, CoinAdventure, CoinAdventureI, CoinAdventureII, CoinAdventureIII, CoinAdventureIV,
	CoinBees, CoinBeesI, CoinBeesII, CoinBeesIII, CoinBeesIV, CoinBlood, CoinBloodI, CoinBloodII, CoinBloodIII, CoinBloodIV, CoinFarmer, CoinFarmerI, CoinFarmerII, CoinFarmerIII, CoinFarmerIV, CoinForestry, CoinForestryI, CoinForestryII, CoinForestryIII, CoinForestryIV,
	CoinSurvivor, CoinSurvivorI, CoinSurvivorII, CoinSurvivorIII, CoinSurvivorIV, CoinSpace, CoinSpaceI, CoinSpaceII, CoinSpaceIII, CoinSpaceIV, CoinChunkloaderTierI, CoinChunkloaderTierII, CoinChunkloaderTierIII, CoinChunkloaderTierIV, CoinChunkloaderTierV, CoinChemist, CoinChemistI, CoinChemistII, CoinChemistIII, CoinChemistIV,
	CoinCook, CoinCookI, CoinCookII, CoinCookIII, CoinCookIV, CoinBlank, CoinBlankI, CoinBlankII, CoinBlankIII, CoinBlankIV, CoinSmith, CoinSmithI, CoinSmithII, CoinSmithIII,  CoinSmithIV, CoinWitch, CoinWitchI, CoinWitchII, CoinWitchIII, CoinWitchIV,
	WetTofu,
